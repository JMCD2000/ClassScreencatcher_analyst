Attribute VB_Name = "SetScreenSparseMatrix_RowCounts"
...
Public Sub Set_SparseMatrix_Counts_SMC()
...
Dim ScreenCountsVar_BT As Integer ' This holds the count of the screens as they are collected accross the row for milestone OWLD
Dim ScreenCountsVar_AT As Integer ' This holds the count of the screens as they are collected accross the row for milestone OWLD
Dim ScreenCountsVar_FCT As Integer ' This holds the count of the screens as they are collected accross the row for milestone OWLD
...
Dim mySQL_update As String ' Updating SQL String
        ...
        Do While Not rst.EOF
            ...
            For Each myDateVarList In allColumnsList
                ...
                ElseIf cur_aCL_Index < (allColumnsList_OWLD + 1) Then
                    ...
                    ScreenCountsVar_BT = rst.Fields(myDateVarList).Value + ScreenCountsVar_BT
                    'Leave myIndex alone here so other Event ranges can be checked
                ...
                If cur_aCL_Index < allColumnsList_AT Then
                    'I am before the Event I am counting, do nothing
                    'ScreenCountsVar_AT = rst.Fields(myDateVarList).Value
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("Column before Event Range of record row: " & myDateVarList)
                ...
                ElseIf cur_aCL_Index < (allColumnsList_OWLD + 1) Then
                    'I am in the Event Range of the date columns
                    ScreenCountsVar_AT = rst.Fields(myDateVarList).Value + ScreenCountsVar_AT
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("In the range of the Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index > allColumnsList_OWLD Then
                    'I am after the Event Range of the date columns, do nothing
                ...
                If cur_aCL_Index < allColumnsList_FCT Then
                    'I am before the Event I am counting, do nothing
                    'ScreenCountsVar_FCT = rst.Fields(myDateVarList).Value
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("Column before Event Range of record row: " & myDateVarList)
                ...
                ElseIf cur_aCL_Index < (allColumnsList_OWLD + 1) Then
                    'I am in the Event Range of the date columns
                    ScreenCountsVar_FCT = rst.Fields(myDateVarList).Value + ScreenCountsVar_FCT
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("In the range of the Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index > allColumnsList_OWLD Then
                    'I am after the Event Range of the date columns, do nothing
    ...
    Else
        ...
        Debug.Print "Function Set_SparseMatrix_Counts_SMC() was passed empty or not expected value with GLOBAL All_or_Events:= " & All_or_Events & "."
    End If
...
Public Sub Set_SparseMatrix_Counts_SMC_DEL()
'This counts the sparse matrix by row in the event to owld date range.
Dim myDateVarList As Variant ' Used to cycle through each date column as an iterable
'These are used on the recordset
'Dim curDateVal As Integer ' This holds the current date column value
...
Dim mySQL_update As String ' Updating SQL String
    ...
    If All_or_Events = "All" Then
        Do While Not rst.EOF
            ...
            For Each myDateVarList In allColumnsList
                ...
                ElseIf cur_aCL_Index = allColumnsList_BT Then
                    'I am on the first Event column I am counting
                    ScreenCountsVar_BT_DEL = rst.Fields(myDateVarList).Value
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("Column starting Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index < (allColumnsList_DEL + 1) Then
                    'I am in the Event Range of the date columns
                    ScreenCountsVar_BT_DEL = rst.Fields(myDateVarList).Value + ScreenCountsVar_BT_DEL
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("In the range of the Event Range of record row: " & myDateVarList)
                ...
                ElseIf cur_aCL_Index = allColumnsList_AT Then
                    'I am on the first Event column I am counting
                    ScreenCountsVar_AT_DEL = rst.Fields(myDateVarList).Value
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("Column starting Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index < (allColumnsList_DEL + 1) Then
                    'I am in the Event Range of the date columns
                    ScreenCountsVar_AT_DEL = rst.Fields(myDateVarList).Value + ScreenCountsVar_AT_DEL
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("In the range of the Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index > allColumnsList_DEL Then
                    'I am after the Event Range of the date columns, do nothing
    ...
    Else
        'Un trapped error
        'All_or_Events Global is empty or not expected value
        Debug.Print "Function Set_SparseMatrix_Counts_SMC_DEL() was passed empty or not expected value with GLOBAL All_or_Events:= " & All_or_Events & "."
    End If
