    ...
    If All_or_Events = "All" Then
        Do While Not rst.EOF
            ...
            For Each myDateVarList In allColumnsList
                ...
                If cur_aCL_Index < allColumnsList_BT Then
                    'I am before the Event I am counting, do nothing
                    'ScreenCountsVar_BT_OWLD = rst.Fields(myDateVarList).Value
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("Column before Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_BT Then
                    'I am on the first Event column I am counting
                ...
                ElseIf cur_aCL_Index < allColumnsList_OWLD Then
                    'I am in the Event Range of the date columns
                    ScreenCountsVar_BT_OWLD = rst.Fields(myDateVarList).Value + ScreenCountsVar_BT_OWLD
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("In the range of the Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_OWLD Then
                    'I am in the Event Range of the date columns
                ...
                If cur_aCL_Index < allColumnsList_BT Then
                    'I am before the Event I am counting, do nothing
                    'ScreenCountsVar_BT_Final = rst.Fields(myDateVarList).Value
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("Column before Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_BT Then
                    'I am on the first Event column I am counting
                ...
                ElseIf cur_aCL_Index < allColumnsList_Final Then
                    'I am in the Event Range of the date columns
                    ScreenCountsVar_BT_Final = rst.Fields(myDateVarList).Value + ScreenCountsVar_BT_Final
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("In the range of the Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_Final Then
                    'I am in the Event Range of the date columns
                ...
                If cur_aCL_Index < allColumnsList_AT Then
                    'I am before the Event I am counting, do nothing
                    'ScreenCountsVar_AT_OWLD = rst.Fields(myDateVarList).Value
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("Column before Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_AT Then
                    'I am on the first Event column I am counting
                ...
                ElseIf cur_aCL_Index < allColumnsList_OWLD Then
                    'I am in the Event Range of the date columns
                    ScreenCountsVar_AT_OWLD = rst.Fields(myDateVarList).Value + ScreenCountsVar_AT_OWLD
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("In the range of the Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_OWLD Then
                    'I am in the Event Range of the date columns
                ...
                If cur_aCL_Index < allColumnsList_AT Then
                    'I am before the Event I am counting, do nothing
                    'ScreenCountsVar_AT_Final = rst.Fields(myDateVarList).Value
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("Column before Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_AT Then
                    'I am on the first Event column I am counting
                ...
                ElseIf cur_aCL_Index < allColumnsList_Final Then
                    'I am in the Event Range of the date columns
                    ScreenCountsVar_AT_Final = rst.Fields(myDateVarList).Value + ScreenCountsVar_AT_Final
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("In the range of the Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_Final Then
                    'I am in the Event Range of the date columns
                ...
                If cur_aCL_Index < allColumnsList_FCT Then
                    'I am before the Event I am counting, do nothing
                    'ScreenCountsVar_FCT_OWLD = rst.Fields(myDateVarList).Value
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("Column before Event Range of record row: " & myDateVarList)
                ...
                ElseIf cur_aCL_Index < allColumnsList_OWLD Then
                    'I am in the Event Range of the date columns
                    ScreenCountsVar_FCT_OWLD = rst.Fields(myDateVarList).Value + ScreenCountsVar_FCT_OWLD
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("In the range of the Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_OWLD Then
                    'I am in the Event Range of the date columns
                ...
                If cur_aCL_Index < allColumnsList_FCT Then
                    'I am before the Event I am counting, do nothing
                    'ScreenCountsVar_FCT_Final = rst.Fields(myDateVarList).Value
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("Column before Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_FCT Then
                    'I am on the first Event column I am counting
                ...
                ElseIf cur_aCL_Index < allColumnsList_Final Then
                    'I am in the Event Range of the date columns
                    ScreenCountsVar_FCT_Final = rst.Fields(myDateVarList).Value + ScreenCountsVar_FCT_Final
                    'Leave myIndex alone here so other Event ranges can be checked
                    'Debug.Print ("In the range of the Event Range of record row: " & myDateVarList)
                ElseIf cur_aCL_Index = allColumnsList_Final Then
                    'I am in the Event Range of the date columns
