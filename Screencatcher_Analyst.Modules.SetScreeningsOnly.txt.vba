...
Public Sub SetFirstScreensAndEvents_SO()
...
notFound = "Not Found"
    ...
    Else
        ...
        Debug.Print "Function SetFirstScreensAndEvents_SO() was passed empty or not expected value with GLOBAL All_or_Events:= " & All_or_Events & "."
    End If
    ...
    CurrentDb.Execute "UPDATE DISTINCTROW " & CurrentTable & " RIGHT JOIN [" & beanFinal & "] ON " & CurrentTable & ".Trial_Card = [" & beanFinal & "].Trial_Card " _
    & "SET " _
    & "" & CurrentTable & ".First_Screening = [" & beanFinal & "].[TC_Screening_AC1_AC2], " _
    & "" & CurrentTable & ".[" & columnFinal & "] = [" & beanFinal & "].[TC_Screening_AC1_AC2], " _
    ...
    & "SET " _
    & "" & CurrentTable & ".First_Screening = [" & beanFCT & "].[TC_Screening_AC1_AC2], " _
    & "" & CurrentTable & ".[" & columnFCT & "] = [" & beanFCT & "].[TC_Screening_AC1_AC2];"
    ...
    & "SET " _
    & "" & CurrentTable & ".First_Screening = [" & beanAT & "].[TC_Screening_AC1_AC2], " _
    & "" & CurrentTable & ".[" & columnAT & "] = [" & beanAT & "].[TC_Screening_AC1_AC2];"
    ...
    & "SET " _
    & "" & CurrentTable & ".First_Screening = [" & beanBT & "].[TC_Screening_AC1_AC2], " _
    & "" & CurrentTable & ".[" & columnBT & "] = [" & beanBT & "].[TC_Screening_AC1_AC2];"
    ...
    & "SET " _
    & "" & CurrentTable & ".[" & columnOWLD & "] = [" & beanOWLD & "].[TC_Screening_AC1_AC2];"
    ...
    & "SET " _
    & "" & CurrentTable & ".[" & columnDEL & "] = [" & beanDEL & "].[TC_Screening_AC1_AC2];"
...
Public Sub SetNonShipEventScrns_SO()
...
Dim myDateVarList As Variant
    ...
    For Each myDateVarList In nonTrialsList
        ...
        & "SET " _
        & "" & CurrentTable & ".[" & myDateVarList & "] = [" & myDateVarList & "_" & curHullNum & "].[TC_Screening_AC1_AC2];"
        ' Debug.Print "done with column table: " & myDateVarList & "."
    Next myDateVarList
...
Public Sub SetLateAdds_TrialCards_SO()
...
Dim myDateVarList As Variant
    ...
    Else
        'Un trapped error
        'All_or_Events Global is empty or not expected value
        Debug.Print "Function SetLateAdds_TrialCards_SO() was passed empty or not expected value with GLOBAL All_or_Events:= " & All_or_Events & "."
    End If
...
Public Sub SetClosedXX_TrialCards_SO()
...
Dim myDateVarList As Variant
    ...
    Else
        'Un trapped error
        'All_or_Events Global is empty or not expected value
        Debug.Print "Function SetClosedXX_TrialCards_SO() was passed empty or not expected value with GLOBAL All_or_Events:= " & All_or_Events & "."
    End If
...
Public Sub SetTrialCardSplits_SO()
...
Dim myDateVarList As Variant
    ...
    Else
        'Un trapped error
        'All_or_Events Global is empty or not expected value
        Debug.Print "Function SetTrialCardSplits_SO() was passed empty or not expected value with GLOBAL All_or_Events:= " & All_or_Events & "."
    End If
