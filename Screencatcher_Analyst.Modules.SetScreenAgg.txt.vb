...
'Set data columns to <Not Found>
    ...
    CurrentDb.Execute "UPDATE DISTINCTROW " & CurrentTable & " RIGHT JOIN [XX_Screen_Only] ON " & CurrentTable & ".Trial_Card = [XX_Screen_Only].Trial_Card " _
    & "SET " _
...
'Set Final Screening as Final and as First
    CurrentDb.Execute "UPDATE DISTINCTROW " & CurrentTable & " RIGHT JOIN [XX_Screen_Only] ON " & CurrentTable & ".Trial_Card = [XX_Screen_Only].Trial_Card " _
    & "SET " _
    & "" & CurrentTable & ".First_Screen = [XX_Screen_Only].[First_Screening], " _
    & "" & CurrentTable & ".[Last_Screen] = [XX_Screen_Only].[" & columnFinal & "], " _
    & "" & CurrentTable & ".Final_Sts_A_T = [XX_Screen_Only].[Final_Sts_A_T], " _
    & "" & CurrentTable & ".Trial_ID = [XX_Screen_Only].[Trial_ID], " _
    & "" & CurrentTable & ".Event = [XX_Screen_Only].[Event];"
...
mySQLstring = "SELECT XX_Screen_Only.* FROM XX_Screen_Only INNER JOIN TC_Screen_Agg ON XX_Screen_Only.Trial_Card = TC_Screen_Agg.Trial_Card;"
